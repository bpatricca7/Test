...
Built by five specialists working to one contract ([`characters/API.md`](characters/API.md)):
...
| Score, foley, dialogue mix | `characters/audio/score.py`, `mix.py` |
| Build | `characters/build.sh` |
