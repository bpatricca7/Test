# Bolt & Luma — an animated short film made with code

See [`film/`](film/): a 2½-minute kids' animated short in the spirit of classic robot
films. Everything in it (3D world, characters, animation, music, sound effects) is
generated by code, and the voices come from a neural text-to-speech model. The rendered
movie is `film/bolt-and-luma.mp4`, and `film/README.md` explains how to rebuild it.
